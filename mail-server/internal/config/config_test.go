...
func clearConfigEnv(t *testing.T) {
	...
	for _, k := range []string{
		...
		// stage 2 canonical keys — cleared so OS-level values can't contaminate cases.
		"ENVIRONMENT", "SECRET_KEY", "CONTEXT", "ACCESS_TOKEN_EXPIRE_MINUTES",
		"REFRESH_TOKEN_EXPIRE_DAYS", "DB_TYPE", "DB_PATH", "DB_HOST", "DB_PORT",
		"DB_USER", "DB_PASSWORD", "DB_DATABASE", "DB_SCHEMA", "ALLOWED_ORIGIN",
		"MAILANCHOR_ALLOWED_ORIGINS", "MAILANCHOR_ALLOWED_ORIGIN", "MAIL_STORAGE_BASE_PATH",
		"GOOGLE_CLIENT_ID", "GOOGLE_CLIENT_SECRET", "GOOGLE_REDIRECT_URI", "REDIS_HOST", "REDIS_PORT", "REDIS_DB",
		"REDIS_PASSWORD", "REDIS_SSL", "ENV_FILE",
	} {
		t.Setenv(k, "")
	}
}
